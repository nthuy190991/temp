...
defaultoptions=struct('Verbose',false,'nPoints',100,'Wline',0.04,'Wedge',2,...
    ...
    'RVEflag',0,'RVEcoeff',0,'DFflag',0,'DFseeds',[],'DFcoeffs',0); % new added options (Huy's modif)
...
%     display(['Iter ' num2str(i)])
    P=SnakeMoveIteration2D(S,P,Fext,I,Options.Gamma,Options.Kappa,Options.Delta,...
        Options.RVEflag,Options.RVEcoeff,Options.DFflag,Options.DFseeds,Options.DFcoeffs);
