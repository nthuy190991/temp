...
xtfping_header.ComputerClockHour = fread(fileID,1);
xtfping_header.ComputerClockMinute = fread(fileID,1);
xtfping_header.ComputerClockSecond = fread(fileID,1);
xtfping_header.ComputerClockHsec = fread(fileID,1);
...
xtfping_header.CableOutHundredths = fread(fileID,1);
